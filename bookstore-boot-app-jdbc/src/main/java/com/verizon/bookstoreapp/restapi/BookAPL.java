package com.verizon.bookstoreapp.restapi;
...
import com.verizon.bookstoreapp.service.BookService;

@RestController
@CrossOrigin
@RequestMapping("/books")

public class BookAPL {
	...
	public ResponseEntity<Void> deleteBookAction(@PathVariable("bcode") int bcode) {
		...
		boolean isDel = bookService.deleteBookById(bcode);
